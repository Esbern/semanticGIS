---
title: HøjdefikspunktDanmark
draft: false
type: entity
---

# HøjdefikspunktDanmark

fast punkt som definerer referencenettet i højden I Danmark

### Semantic Template
```python
p.io.declare_input(
    output_name="højdefikspunktdanmark",
    attributes={
        "herredsogn": {
        ...
        "koteklasse": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Fikspunkter.KoteklasseVærdi, str),
            "cardinality": "0..1",
            "description": "angivelse af kvalitet af koten"
        },
        "kommunekode": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

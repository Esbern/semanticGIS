...
lokalitet, hvor der foregår undervisning

### Semantic Template
```python
p.io.declare_input(
    output_name="undervisningssted",
    attributes={
        "undervisningsstedtype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.Undervisningsstedtype, str),
            "cardinality": "1..1",
            "description": "underinddeling af Undervisningssted på baggrund af formål og funktion"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

...
knudepunkt i et vandløbsnetværk

### Semantic Template
```python
p.io.declare_input(
    output_name="vandknude",
    attributes={
        "applikation": {
        ...
        "knudetype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.knudetypeværdi, str),
            "description": "vandløbsadministrationens angivelse af knudetype"
        },
        "kommentar": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

---
title: Vandafstrømningsopland
draft: false
type: entity
---

# Vandafstrømningsopland

det opland, der forsyner dele af et vandløbssystem med afstrømmende overfladevand

### Semantic Template
```python
p.io.declare_input(
    output_name="vandafstrømningsopland",
    attributes={
        "vanduuid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "reference til vandløbsadministrationen"
        },
        "afvandertil": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "reference til modtageren i vandløbsadministrationen af overfladevandet fra dette opland"
        },
        "oplandstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.GeoDanmark.OplandstypeVærdi, str),
            "cardinality": "1..1",
            "description": "angiver typen af opland"
        },
        "oplandsordenskode": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "vandløbsadministrationens kode til dette opland"
        },
        "link": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

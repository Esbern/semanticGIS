...
```python
p.io.declare_input(
    output_name="navigationsanlaeg",
    attributes={
        "carisid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "description": "unik kode på fire bogstaver der identificerer et navigationsanlæg i Geodatastyrelsens søkortproduktionssystem CARIS"
        },
        ...
        "hoejde": {
            ...
            "description": "vertikal udtrækning fra bund til top"
        },
        "id_lokalid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.PK(str),
        ...
        "navigationsanlaegstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.navigationsanlægværdi, str),
            "description": "underinddeling af Navigationsanlæg på baggrund af anlæggets konstruktion"
        },
        "objectid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

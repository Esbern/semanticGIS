...
geografisk inddeling af kommunerne i områder, hvor vælgere stemmer til Folketings-, EU- og Kommunevalg, samt til folkeafstemninger
...
```python
p.io.declare_input(
    output_name="afstemningsområde",
    attributes={
        "afstemningsomradenummer": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "to-cifret nummerering"
        },
        "afstemningsstednavn": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "navnet på det sted hvor valghandlingen foretages"
        },
        ...
        "opstillingskreds": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.FK(dk.DAGI.Opstillingskreds, str),
            "cardinality": "1..1",
            "description": ""
        },
        "afstemningsstedhusnummer": {
            "scale": MeasurementScale.NOMINAL,

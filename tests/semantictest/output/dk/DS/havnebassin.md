...
p.io.declare_input(
    ...
    attributes={
        ...
        "havnebassintype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.havnebassinværdi, str),
            "description": "underinddeling af Havnebassin på baggrund af de opankrende fartøjer"
        },
        "id_lokalid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.PK(str),

...
afgrænsning af et færdselsareal benyttet til motoriseret, gående, cyklende eller ridende færdsel
...
p.io.declare_input(
    ...
    attributes={
        ...
        "synligvejkant": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(bool),
            "description": "angivelse af vejkantens synlighed i et ortofoto"
        },
        "tempid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "type": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.vejkanttypeværdi, str),
            "description": "angivelse af vejkantens type"
        },

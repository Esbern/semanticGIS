...
et vandløbs sideafgrænsning. Sideafgrænsningen er på kronekanten

### Semantic Template
```python
p.io.declare_input(
    output_name="vandloebskant",
    attributes={
        "applikation": {
        ...
        "synligvandloebskant": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(bool),
            "description": "vandløbskant synlig på flyfoto eller ej (f.eks. under bro)"
        },
        "tempid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "underminimumvandkant": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(bool),
            "description": "længde er mindre end minimumslængden, som er defineret i GeoDanmark-Specifikationen"
        },
        "vanduuid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

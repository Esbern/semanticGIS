...
spor af fortiden i form af menneskeskabt bygværk eller efterladenskaber af menneskelig aktivitet
...
p.io.declare_input(
    ...
    attributes={
        "fortidsmindetype": {
            ...
            "role": sg.LOOKUP(dk.Stednavne.Fortidsmindetype, str),
            "cardinality": "1..1",
            "description": "underinddeling af Fortidsminde på baggrund af historisk anvendelse"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

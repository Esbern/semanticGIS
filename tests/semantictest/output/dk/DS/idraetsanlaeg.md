...
område med baner, lokaler og udstyr til idrætsudøvelse

### Semantic Template
```python
p.io.declare_input(
    output_name="idraetsanlaeg",
    attributes={
        ...
        "areal": {
            ...
            "description": "geografisk horisontal udstrækning af et Idrætsanlæg som flade"
        },
        ...
        "idraetsanlaegstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.idrætsanlægværdi, str),
            "description": "underinddeling af Idrætsanlæg på baggrund af idrætsgrene"
        },
        "objectid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "skyderetning": {
            "scale": MeasurementScale.RATIO,
            "role": sg.DES(int),
            "description": "geografisk orientering af en skydebane"
        },
        "status": {
            "scale": MeasurementScale.NOMINAL,

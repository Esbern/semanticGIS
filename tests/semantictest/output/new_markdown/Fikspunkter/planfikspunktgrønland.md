---
title: PlanfikspunktGrønland
draft: false
type: entity
---

# PlanfikspunktGrønland

fast punkt som definerer referencenettet i planet, beliggende i Grønland

### Semantic Template
```python
p.io.declare_input(
    output_name="planfikspunktgrønland",
    attributes={
        "northing": {
        ...
        "refgr": {
            ...
            "role": sg.DES(bool),
            "cardinality": "1..1",
            "description": "angivelse om det plane fikspunkt hørere til RefGR nettet"
        },
        "fikspunktsnummer": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

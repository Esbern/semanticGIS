...
et bestemt menneskeskabt sted, som nogen kan finde nyttigt eller interessant

### Semantic Template
```python
p.io.declare_input(
    output_name="andetnavngivetsted",
    attributes={
        "andetnavngivetstedtype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.AndetNavngivetStedtype, str),
            "cardinality": "1..1",
            "description": "en bestemt menneskeskabt lokation(funktion) - ofte ikke et selvstændigt objekt"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

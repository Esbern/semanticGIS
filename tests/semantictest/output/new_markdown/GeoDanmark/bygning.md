...
p.io.declare_input(
    ...
    attributes={
        "bygningstype": {
            ...
            "role": sg.LOOKUP(dk.GeoDanmark.BygningstypeVærdi, str),
            "cardinality": "1..1",
            "description": "angiver type af bygning med én af de anførte værdier"
        },
        "malestedbygning": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.GeoDanmark.MålestedBygningVærdi, str),
            "cardinality": "1..1",
            "description": "angiver den metode, objektet er stedfæstet med"
        },
        "metode3d": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.GeoDanmark.Metode3DVærdi, str),
            "cardinality": "1..1",
        ...
        "bbraktion": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.GeoDanmark.BBRaktionVærdi, str),
            "cardinality": "0..1",

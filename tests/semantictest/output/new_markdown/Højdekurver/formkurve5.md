...
generaliserede kurver med ækvidistance på 5m der giver et indtryk af terrænet ved repræsentation i mindre målestok

### Semantic Template
```python
p.io.declare_input(
    output_name="formkurve5",
    attributes={
        "geometri": {
        ...
        "hjlpekurve": {
            ...
            "role": sg.DES(bool),
            "cardinality": "1..1",
            "description": "visuel hjælp til at skabe sammenhæng i kurvebilledet"
        },
        "hjde": {
            "scale": MeasurementScale.RATIO,
            "role": sg.DES(float),

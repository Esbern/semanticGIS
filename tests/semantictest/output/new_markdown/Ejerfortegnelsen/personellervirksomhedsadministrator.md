---
title: PersonEllerVirksomhedsadministrator
draft: false
type: entity
---

# PersonEllerVirksomhedsadministrator
...
```python
p.io.declare_input(
    output_name="personellervirksomhedsadministrator",
    attributes={
        "administreretpersonellervirksomhed": {

...
```python
p.io.declare_input(
    output_name="hoejspaendingsledning",
    attributes={
        "applikation": {
        ...
        "spaending": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.spændingværdi, str),
            "description": "det nominelle spændingsinterval for ledningen"
        },
        "status": {
            "scale": MeasurementScale.NOMINAL,

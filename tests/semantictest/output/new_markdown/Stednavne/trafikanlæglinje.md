...
topografisk linjeobjekt, som beskriver lokalitet, som vedrører personers og transportmidlers bevægelse ad en rute, en færdselsåre e.l., til lands, til vands eller i luften

### Semantic Template
```python
p.io.declare_input(
    output_name="trafikanlæglinje",
    attributes={
        "geometri": {
        ...
        "lngde": {
            ...
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "geografisk horisontal udstrækning af et Trafikanlæg som linje"
        },
        "trafikanlgtype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.Trafikanlægstype, str),
            "cardinality": "1..1",
            "description": "underinddeling af Trafikanlæg på baggrund af anlæggets funktion og placering"
        },
        "bruger": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

...
geografisk inddeling af landet i valglandsdele til fordeling af mandater til Folketinget
...
```python
p.io.declare_input(
    output_name="valglandsdel",
    attributes={
        "valglandsdelsbogstav": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "landsdelens bogstav jf. lovbekendtgørelse nr 128/2013"
        },
        "id_lokalid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.PK(str),

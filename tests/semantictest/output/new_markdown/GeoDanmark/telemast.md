...
p.io.declare_input(
    ...
    attributes={
        ...
        "medietype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.GeoDanmark.MedietypeVærdi, str),
            "cardinality": "1..1",
            "description": "typen af radiosignaler. Kun én værdi kan angives, selv om der kan være flere typer sendere på masten"
        },
        "underminimumtelemast": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",

...
```python
p.io.declare_input(
    output_name="jordstykketemaflade",
    attributes={
        "geometri": {
        ...
        "temafladeid": {
            ...
            "role": sg.DES(int),
            "cardinality": "1..1",
            "description": "unik identifikation af temafladen"
        },
        "tematype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Matrikel.Tematype, str),
            "cardinality": "1..1",
            "description": "typen af tema der er registreret på det pågældende jordstykke"
        },
        "jordstykke": {
            "scale": MeasurementScale.NOMINAL,

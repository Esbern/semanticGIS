...
vejforløb med rutenavn eller -nummer
...
p.io.declare_input(
    ...
    attributes={
        ...
        "laengde": {
            ...
            "description": "geografisk horisontal udstrækning af en Rute som linje"
        },
        "objectid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "rutetype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.ruteværdi, str),
            "description": "underinddeling af Rute på baggrund af Vejdirektoratets inddelinger"
        },
        "status": {
            "scale": MeasurementScale.NOMINAL,

...
p.io.declare_input(
    ...
    attributes={
        ...
        "sportstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.sportstypeværdi, str),
            "description": "angiver typen af sport der primært udføres på banen"
        },
        "status": {
            "scale": MeasurementScale.NOMINAL,
        ...
        "underminimumsport": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(bool),
            "description": "længden af sportsbane er mindre end det minimum, som er defineret i GeoDanmark-Specifikationen"
        },

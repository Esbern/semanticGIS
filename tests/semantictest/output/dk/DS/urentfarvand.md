...
```python
p.io.declare_input(
    output_name="urentfarvand",
    attributes={
        "areal": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.area, str),
            "description": "geografisk horisontal udstrækning af et UrentFarvand som flade"
        },
        ...
        "urentfarvandtype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.urentfarvandværdi, str),
            "description": "underinddeling af UrentFarvand på baggrund af havbundsforhold"
        },
        "virkningfra": {
            "scale": MeasurementScale.INTERVAL,
            "role": sg.DES(datetime),

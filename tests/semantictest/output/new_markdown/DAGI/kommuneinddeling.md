...
den kommunale myndigheds geografiske afgrænsning som fastlagt i loven
...
p.io.declare_input(
    ...
    attributes={
        ...
        "udenforkommuneinddeling": {
            ...
            "role": sg.DES(bool),
            "cardinality": "1..1",
            "description": "område uden for kommuneinddeling"
        },
        "region": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.FK(dk.DAGI.Regionsinddeling, str),
            "cardinality": "1..1",
            "description": ""
        },
        "id_lokalid": {

...
topografisk punktobjekt, som beskriver lokalitet, som vedrører personers og transportmidlers bevægelse ad en rute, en færdselsåre e.l., til lands, til vands eller i luften

### Semantic Template
```python
p.io.declare_input(
    output_name="trafikanlægpunkt",
    attributes={
        "geometri": {

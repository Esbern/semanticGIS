...
åbent, ubebygget område, ofte med en bestemt funktion eller beregnet til en bestemt aktivitet
...
p.io.declare_input(
    ...
    attributes={
        "areal": {
            ...
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "geografisk horisontal udstrækning af en Plads som flade"
        },
        "pladstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.Pladstype, str),
            "cardinality": "1..1",
            "description": "underinddeling af Plads"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

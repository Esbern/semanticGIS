# Danmarks Administrative Geografiske Inddeling entity catalog (direct attributes)
...
- afstemningsområde: Afstemningsområde -> Afstemningsområde (role kommune; 1..* ⇢ 1..1)
- afstemningsområde: Afstemningsområde -> Afstemningsområde (role opstillingskreds; 1..* ⇢ 1..1)
- afstemningsområde: Afstemningsområde -> Afstemningsområde (role afstemningsstedHusnummer; 1..1 ⇢ 1..1)

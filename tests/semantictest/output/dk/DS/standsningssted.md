...
sted hvor et transportmiddel standser for at optage og/eller afsætte passagerer

### Semantic Template
```python
p.io.declare_input(
    output_name="standsningssted",
    attributes={
        ...
        "standsningsstedtype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.standsningsstedværdi, str),
            "description": "underinddeling af Standsningssted på baggrund af typen af benyttende køretøjstype"
        },
        "status": {
            "scale": MeasurementScale.NOMINAL,

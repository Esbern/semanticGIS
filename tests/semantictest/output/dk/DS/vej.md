...
vejstrækning med navn der ikke er registreret i adresseregistret
...
p.io.declare_input(
    ...
    attributes={
        ...
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.gm_curve, str),
        ...
        "laengde": {
            ...
            "description": "geografisk horisontal udstrækning af en Vej som linje"
        },
        "objectid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "vejtype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.vejværdi, str),
            "description": "underinddeling af Vej på baggrund af vejens funktion, placering og belægning"
        },
        "virkningfra": {
            "scale": MeasurementScale.INTERVAL,
            "role": sg.DES(datetime),

...
p.io.declare_input(
    ...
    attributes={
        ...
        "soetype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.søtypeværdi, str),
            "description": "angivelse af søens anvendelse"
        },
        "status": {
            "scale": MeasurementScale.NOMINAL,
        ...
        "underminimumsoe": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(bool),
            "description": "angivelse af om arealet er mindre end den minimumstørrelse på en sø, som er defineret i GeoDanmark-Specifikationen"
        },
        "vanduuid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

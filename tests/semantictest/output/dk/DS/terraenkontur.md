...
p.io.declare_input(
    ...
    attributes={
        ...
        "laengde": {
            ...
            "description": "geografisk horisontal udstrækning af en Terrænkontur som linje"
        },
        "objectid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "terraenkonturtype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.terrænkonturværdi, str),
            "description": "underinddeling af Terrænkontur på baggrund af konstruktionens formål"
        },
        "virkningfra": {
            "scale": MeasurementScale.INTERVAL,
            "role": sg.DES(datetime),

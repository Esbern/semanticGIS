...
område hvor de døde ligger begravet

### Semantic Template
```python
p.io.declare_input(
    output_name="begravelsesplads",
    attributes={
        ...
        "areal": {
            ...
            "description": "geografisk horisontal udstrækning af en Begravelsesplads som flade"
        },
        "begravelsespladstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.begravelsespladsværdi, str),
            "description": "underinddeling af Begravelsplads på baggrund af religion"
        },

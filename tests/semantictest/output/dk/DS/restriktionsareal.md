...
```python
p.io.declare_input(
    output_name="restriktionsareal",
    attributes={
        "areal": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.area, str),
            "description": "geografisk horisontal udstrækning af et Restriktionsareal som flade"
        },
        ...
        "restriktionsarealtype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.restriktionsarealværdi, str),
            "description": "underinddeling af Restriktionsareal på baggrund af typen af begrænsninger der påhviler brugerne"
        },
        "status": {
            "scale": MeasurementScale.NOMINAL,

...
p.io.declare_input(
    ...
    attributes={
        ...
        "underterrn": {
            ...
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "angiver om objektet ligger under eller over terræn"
        },
        "underminimumtanflade": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "arealet er mindre end minimumsarealet, som er defineret i GeoDanmark-Specifikationen"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "bbr": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.FK(dk.BygningerOgBoliger.Bygværkselement, str),
            "cardinality": "0..1",
            "description": ""
        },
        "id_lokalid": {

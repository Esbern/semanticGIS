...
markering af et område, der skal ajourføres indenfor

### Semantic Template
```python
p.io.declare_input(
    output_name="udpegningflade",
    attributes={
        "aar": {
        ...
        "aktion": {
            ...
            "role": sg.LOOKUP(dk.geodkv.lookups.aktionværdi, str),
        ...
        "foretaget": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.foretagetværdi, str),

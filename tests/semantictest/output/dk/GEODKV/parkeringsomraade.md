...
p.io.declare_input(
    ...
    attributes={
        ...
        "parkeringsid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "description": "entydig reference til et element i et parkeringsregister"
        },
        "placering": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.placeringværdi, str),
            "description": "placering af parkeringsområdet"
        },
        "plannoejagtighed": {
            "scale": MeasurementScale.NOMINAL,

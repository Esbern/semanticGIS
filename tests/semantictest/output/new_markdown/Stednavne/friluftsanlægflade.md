...
topografisk linjeobjekt, som beskriver område med plads til friluftsanlæg og friluftsaktiviteter

### Semantic Template
```python
p.io.declare_input(
    output_name="friluftsanlægflade",
    attributes={
        "areal": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "geografisk horisontal udstrækning af en Friluftsanlæg som flade"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "friluftsanlgstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.Friluftsanlægstype, str),
            "cardinality": "1..1",
            "description": "underinddeling af Friluftsanlæg på baggrund af funktion"
        },
        "bruger": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

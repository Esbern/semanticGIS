...
p.io.declare_input(
    ...
    attributes={
        "anvendelse": {
            ...
            "role": sg.LOOKUP(dk.geodkv.lookups.skovanvendelseværdi, str),
            "description": "angivelse af skovens primære anvendelse"
        },
        "applikation": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "ejerskov": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.skovejerværdi, str),
            "description": "angivelse af ejerkategorien for skoven"
        },

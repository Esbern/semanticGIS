...
særligt indrettet areal benyttet til ophold i overnatningsenheder som fx telte, campingvogne, autocampere, mobilehomes, campinghytter, trætophytter m.v

### Semantic Template
```python
p.io.declare_input(
    output_name="campingplads",
    attributes={
        "areal": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "geografisk horisontal udstrækning af en Campingplads som flade"
        },
        "campingpladstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.Campingpladstype, str),
            "cardinality": "1..1",
            "description": "underinddeling af Campingplads"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

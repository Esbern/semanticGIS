...
naturlige eller gravede aflange fordybninger i landskabet, som regel med strømmende vand. Kan på nogle strækninger være rørlagte
...
p.io.declare_input(
    ...
    attributes={
        ...
        "lngde": {
            ...
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "geografisk horisontal udstrækning af et Vandløb som linje"
        },
        "vandlbstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.Vandløbstype, str),
            "cardinality": "1..1",
            "description": "underinddeling af Vandløb"
        },
        "bruger": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

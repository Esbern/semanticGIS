...
midte af en naturlig eller gravet, åben eller rørlagt rende til vand

### Semantic Template
```python
p.io.declare_input(
    output_name="vandloebsmidte",
    attributes={
        "applikation": {
        ...
        "faldretning": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.faldretningværdi, str),
            "description": "hvilken vej falder vandløbet i forhold til koordinatrækkefølgen"
        },
        "feltliste": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "fraknude": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "description": "den knude, der forsyner dette segment"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
        ...
        "link": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "description": "en henvisning til yderligere oplysninger om dette objekt"
        },
        "midtebredde": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.midtebreddeværdi, str),
            "description": "angivelse af vandløbets bredde i ét af de angivne intervaller. Bredden måles ved kronekant, hvis en sådan findes, ellers registreres ved vandspejl svarende til placeringen af Vandløbskant"
        },
        "netvaerk": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(bool),
            "description": "angiver om Vandløbsmidte er del af et netværk"
        },
        "objectid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "synligvandloebsmidte": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(bool),
            "description": "angiver objektets synlighed i et ortofoto"
        },
        "tempid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "tilknude": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "description": "den knude, der forsynes af dette segment"
        },
        "vandloebstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.vandløbstypeværdi, str),
            "description": "typen af Vandløbsmidte - almindelig, rørlagt, gennem sø"
        },
        "vanduuid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "description": "officiel unik nøgle fra vandløbsadministrationen"
        },

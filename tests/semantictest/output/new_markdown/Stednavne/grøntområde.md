...
```python
p.io.declare_input(
    output_name="grøntområde",
    attributes={
        "areal": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "geografisk horisontal udstrækning af et GrøntOmråde som flade"
        },
        "grntomradetype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.GrøntOmrådetype, str),
            "cardinality": "1..1",
            "description": "underinddeling af GrøntOmråde på baggrund af anvendelse"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

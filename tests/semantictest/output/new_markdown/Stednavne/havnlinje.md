...
topografisk linjeobjekt, som beskriver område med plads til skibsfartøjer og aktiviteter ifm. skibstrafik og lystsejlads m.v

### Semantic Template
```python
p.io.declare_input(
    output_name="havnlinje",
    attributes={
        "lngde": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "geografisk horisontal udstrækning af en Havn som linje"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "havnetype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.Havnetype, str),
            "cardinality": "1..1",
            "description": "underinddeling af Havn på baggrund af funktion"
        },
        "bruger": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

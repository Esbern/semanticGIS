...
```python
p.io.declare_input(
    output_name="vandløbsmidte",
    attributes={
        "vandlbstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.GeoDanmark.VandløbstypeVærdi, str),
            "cardinality": "1..1",
        ...
        "faldretning": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.GeoDanmark.FaldretningVærdi, str),
            "cardinality": "1..1",
        ...
        "midtebredde": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.GeoDanmark.MidtebreddeVærdi, str),
            "cardinality": "1..1",

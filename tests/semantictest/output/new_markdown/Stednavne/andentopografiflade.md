...
topografisk fladeobjekt, der ikke falder ind i en af Danske Stednavnes øvrige objekttyper

### Semantic Template
```python
p.io.declare_input(
    output_name="andentopografiflade",
    attributes={
        "areal": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "geografisk horisontal udstrækning af en AndenTopografiFlade"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "opbygning af punkter og/eller linjer og/eller flader der tilsammen udgør en geografisk figur"
        },
        "andentopografitype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.AndenTopografitype, str),
            "cardinality": "1..1",
            "description": "underinddeling af AndenTopografi på baggrund af udseende og anvendelse"
        },
        "bruger": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

...
geografisk miljø, primært kendetegnet ved ensartede bevoksnings- og jordbundsforhold
...
p.io.declare_input(
    ...
    attributes={
        ...
        "naturarealtype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.Naturarealtype, str),
            "cardinality": "1..1",
            "description": "underinddeling af Naturareal på baggrund af botaniske og geologiske forhold"
        },
        "bruger": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

...
fladeobjekt indberettet via den fælles indberetningsportal for Stednavne

### Semantic Template
```python
p.io.declare_input(
    output_name="ubearbejdetnavnflade",
    attributes={
        ...
        "ubearbejdetnavntype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.ubearbejdetnavnværdi, str),

...
et område med tekniske funktioner og/eller indretninger. Omfatter forsyningsanlæg, rensningsanlæg, genbrugspladser m.v
...
p.io.declare_input(
    ...
    attributes={
        "areal": {
            ...
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "geografisk horisontal udstrækning af et TekniskAnlæg som flade"
        },
        "tekniskanlgstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.TekniskAnlægstype, str),
            "cardinality": "1..1",
            "description": "underinddeling af TekniskAnlæg på baggrund af funktion"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

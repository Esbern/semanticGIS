...
p.io.declare_input(
    ...
    attributes={
        ...
        "ejerjernbane": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.ejerjernbaneværdi, str),
            "description": "ejeren af den jernbane som objektet repræsenterer"
        },
        "feltliste": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "niveaujernbane": {
            ...
            "description": "angiver hvorvidt jernbanen befinder sig på en bro eller i en tunnel"
        },
        "objectid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "sportype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.sportypeværdi, str),
            "description": "typen af jernbanespor"
        },
        "status": {
            "scale": MeasurementScale.NOMINAL,
        ...
        "togtype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.togtypeværdi, str),
            "description": "typen af tog der kører på disse skinner"
        },

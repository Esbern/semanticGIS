...
geografisk inddeling af valglandsdele i storkredse til fordeling af mandater til Folketinget
...
```python
p.io.declare_input(
    output_name="storkreds",
    attributes={
        "storkredsnummer": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "storkredsens nummer jf. lovbekendtgørelse nr 128/2013"
        },
        "valglandsdel": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.FK(dk.DAGI.Valglandsdel, str),
            "cardinality": "1..1",
            "description": ""
        },
        "id_lokalid": {

...
p.io.declare_input(
    ...
    attributes={
        ...
        "areal": {
            ...
            "description": "geografisk horisontal udstrækning af en Seværdighed som flade"
        },
        ...
        "sevaerdighedstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.seværdighedværdi, str),
            "description": "underinddeling af Seværdighed på baggrund af de udstillede genstande eller forlystelser"
        },
        "status": {
            "scale": MeasurementScale.NOMINAL,

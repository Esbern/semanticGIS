...
p.io.declare_input(
    ...
    attributes={
        ...
        "beskyttelse": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.beskyttelseværdi, str),
            "description": "angivelse af digets beskyttelsesniveau"
        },
        "dataansvar": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "digetype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.digetypeværdi, str),
            "description": "angivelse af digeart"
        },
        "eksisterer": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(bool),
            "description": "diget eksisterer i naturen - true/false"
        },

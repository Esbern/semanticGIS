...
område hvor fly kan starte og lande, og hvor der er bygninger og faciliteter til afvikling af flytrafik

### Semantic Template
```python
p.io.declare_input(
    output_name="lufthavn",
    attributes={
        ...
        "areal": {
            ...
            "description": "geografisk horisontal udstrækning af en Lufthavn som flade"
        },
        ...
        "ejerformtype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.ejerformværdi, str),
            "description": "organisationstype der har ejendomsretten til lufthavnen, og som benytter den i daglig drift"
        },
        ...
        "iatakode": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "description": "unik kode på tre bogstaver der identificerer en lufthavn hos International Air Transport Association (IATA)"
        },
        "icaokode": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "description": "unik kode på fire bogstaver der identificerer en lufthavn hos International Civil Aviation Organisation (ICAO) under de Forenede Nationer (FN)"
        },
        "id_lokalid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.PK(str),
        ...
        "lufthavnstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.flyvepladsværdi, str),
            "description": "underinddeling af Lufthavn på baggrund af de fly der kan benytte området"
        },
        "objectid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

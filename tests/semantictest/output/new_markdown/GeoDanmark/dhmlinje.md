...
p.io.declare_input(
    ...
    attributes={
        ...
        "kotested": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.GeoDanmark.KotestedVærdi, str),
            "cardinality": "1..1",

...
p.io.declare_input(
    ...
    attributes={
        ...
        "campingpladstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.ds.lookups.campingpladsværdi, str),
            "description": "underinddeling af Campingplads"
        },
        "campingraadsnummer": {
            "scale": MeasurementScale.RATIO,
            "role": sg.DES(int),
            "description": "unik kode der identificerer en campingplads hos Campingrådet, hvis campingpladsen er medlem af samme"
        },

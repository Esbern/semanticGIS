...
topografisk punktobjekt, som beskriver lokalitet, som vedrører forlystelse, bygningsværk eller andet af interesse for besøgende

### Semantic Template
```python
p.io.declare_input(
    output_name="attraktionpunkt",
    attributes={
        "geometri": {

...
fast, fritstående konstruktion med vægge og tag, beregnet til at rumme fx beboelse, kontorer, kulturaktiviteter
...
p.io.declare_input(
    ...
    attributes={
        "bygningstype": {
            ...
            "role": sg.LOOKUP(dk.Stednavne.Bygningstype, str),
            "cardinality": "1..1",

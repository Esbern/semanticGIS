...
p.io.declare_input(
    ...
    attributes={
        ...
        "brugesher": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.brugesherværdi, str),
            "description": "angivelse af hvilken type hydrologisk højdemodel dette objekt medvirker til at beregne"
        },
        "dataansvar": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "dimension": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "description": "minimumstværsnitsarealet"
        },
        ...
        "hindring": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.hindringværdi, str),
            "description": "den forhindring som tilpasningen korrigerer"
        },
        "id_lokalid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.PK(str),
        ...
        "kategori": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.kategoriværdi, str),
            "description": "kategori af underføring"
        },
        "kommentar": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "kote": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.real, float),
            "description": "den faste kote for objektet"
        },
        "kotested": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.kotestedværdi, str),
            "description": "hvorfra skal koten til tilpasningen læses"
        },
        "objectid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

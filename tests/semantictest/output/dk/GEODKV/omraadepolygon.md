...
p.io.declare_input(
    ...
    attributes={
        ...
        "ejerop": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.ejerop, str),
            "description": "angivelse af hvem der har ansvaret for forløbet af Områdepolygon"
        },
        ...
        "omraadetype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.områdetypeværdi, str),
            "description": "angivelse af typen af Områdepolygon"
        },
        "plannoejagtighed": {
            "scale": MeasurementScale.NOMINAL,

...
sammenhængende areal, hvis udbredelse for det meste er defineret ud fra overfladeform og placering i landskabet

### Semantic Template
```python
p.io.declare_input(
    output_name="landskabsform",
    attributes={
        "areal": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "geografisk horisontal udstrækning af en Landskabsform som flade"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "landskabsformtype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.Landskabsformstype, str),
            "cardinality": "1..1",
            "description": "underinddeling af Landskabsform på baggrund af geografiske forhold"
        },
        "bruger": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

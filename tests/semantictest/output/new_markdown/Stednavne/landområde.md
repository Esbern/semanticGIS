...
større jordareal eller landstrækning, ofte betragtet som modsætning til et område dækket af hav

### Semantic Template
```python
p.io.declare_input(
    output_name="landområde",
    attributes={
        "areal": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "geografisk horisontal udstrækning af et Landområde som flade"
        },
        "landomradetype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.Landområdetype, str),
            "cardinality": "1..1",
            "description": "underinddeling af Landområde på baggrund af geografi"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

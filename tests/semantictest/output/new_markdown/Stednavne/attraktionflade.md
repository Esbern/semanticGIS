...
topografisk fladeobjekt, som beskriver lokalitet, som vedrører forlystelse, bygningsværk eller andet af interesse for besøgende

### Semantic Template
```python
p.io.declare_input(
    output_name="attraktionflade",
    attributes={
        "geometri": {
        ...
        "areal": {
            ...
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "geografisk horisontal udstrækning af en Attraktion som flade"
        },
        "attraktionstype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.Stednavne.Attraktionstype, str),
            "cardinality": "1..1",
            "description": "underinddeling af Attraktion på baggrund af attraktionens type"
        },
        "adressekobling": {
            "scale": MeasurementScale.NOMINAL,

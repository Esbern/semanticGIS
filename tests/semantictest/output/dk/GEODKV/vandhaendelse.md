...
angivelse af vandhændelse

### Semantic Template
```python
p.io.declare_input(
    output_name="vandhaendelse",
    attributes={
        "applikation": {
        ...
        "haendelsestype": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.LOOKUP(dk.geodkv.lookups.hændelsestypeværdi, str),
            "description": "vandløbsadministrationens hændelseskode til dette sted"
        },
        "id_lokalid": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.PK(str),
        ...
        "kote": {
            ...
            "description": "kote for dette sted. F.eks. overløbskoten for et stigbord"
        },
        "link": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "station": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "description": "vandløbsadministrationens station til dette sted"
        },
        "status": {
            "scale": MeasurementScale.NOMINAL,

...
```python
p.io.declare_input(
    output_name="fotoindex",
    attributes={
        "wmsnavn": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "navnet på den tilhørende WMS-service med fotoserien"
        },
        "fotonummer": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "nummeret på det foto, som polygonen omkranser"
        },
        "fotopixel": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "den nominelle størrelse på en pixel i det originale billede i cm. F.eks. 10"
        },
        "ortopixel": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "størrelsen på en pixel i ortofotoet i cm. F.eks. 12,5"
        },
        "northing": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "koordinat til projektionscenteret for fotoet i specifikationens koordinatsystem"
        },
        "easting": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
        ...
        "kappa": {
            ...
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "fotoets drejning i forhold til flyveretningen"
        },
        "phi": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "fotoets vipning i forhold til vandret i flyveretningen"
        },
        "omega": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),
            "cardinality": "1..1",
            "description": "fotoets vipning i forhold til vandret på tværs af flyveretningen"
        },
        "geometri": {
            "scale": MeasurementScale.NOMINAL,
            "role": sg.DES(str),

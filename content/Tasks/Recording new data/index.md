...
While we can **observe** countless phenomena, we cannot map, enumerate, or analyse them in a structured way without an **Ontology** defined as a Domain of Discourse or at least as a Universe of Discourse (See phase 1 and 2 of the [[Design Rationale]]). An ontology is the formal "rulebook" that allows us to move from "unstructured" observation to "structured" **Recording**—the process of creating data.
